#!/bin/bash
# test_decoy_jitter.sh - Test decoy traffic timing (30s ± 5%)
...
echo "⏱️  Testing decoy traffic timing..."

# Create timing test
cat > test_decoy_timing.rs << 'EOF'
...
rustc test_decoy_timing.rs --extern privachain_messenger=target/release/libprivachain_messenger.rlib -L target/release/deps
./test_decoy_timing

# Clean up
rm -f test_decoy_timing.rs test_decoy_timing

echo "✅ Decoy traffic timing tests completed successfully!"